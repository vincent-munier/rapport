...
\include{languages-tex/xml}
\include{languages-tex/java}
\include{languages-tex/scala}
\include{languages-tex/javascript}
...
\title
    ...
    \date{
      \normalsize{
        \vspace{40mm}
        Maître de stage : Damián Arregui\\
    ...
    \abstract{Le candidat rejoindra \textbf{l’équipe Infrastructure},
      ...
      Java, Scala, Play Framework, JavaScript, HTML/CSS, ExtJS, Amazon Web
      Services, Chef, Ubuntu Linux.
    }
    ...
    \begin{onehalfspace}           % Pour avoir un interligne de 1,5
      ...
      \input{pages/entreprise}
      \input{pages/outils}
      \input{pages/scrum}
      \input{pages/contexte}
      \input{pages/realisations}
      \input{pages/bilan}
